...
import { Users, FolderOpen, CheckSquare, AlertTriangle, Clock } from "lucide-react"
...
export default function DashboardPage() {
  ...
  const taskCompletionRate = stats ? Math.round((stats.tasksByStatus.DONE / (stats.totalTasks || 1)) * 100) : 0
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
          <Card className="col-span-4">
            <CardHeader>
              ...
              <CardDescription>Overview of task completion across all projects</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Completed</span>
                  <span className="text-sm text-muted-foreground">{stats?.tasksByStatus.DONE || 0} tasks</span>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-600">{stats?.tasksByStatus.TODO || 0}</div>
                  <div className="text-xs text-muted-foreground">To Do</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">{stats?.tasksByStatus.IN_PROGRESS || 0}</div>
                  <div className="text-xs text-muted-foreground">In Progress</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{stats?.tasksByStatus.DONE || 0}</div>
